                                ...
                                <tbody>
                                    ...
                                    $count=1;
                                        if(isset($_GET['FBySID'])){
                                            ...
                                            $query = "SELECT * FROM returnbooks where StudentId ='$StudentFID'";
                                        }elseif(isset($_GET['CFbySubject'])){
                                            $SubjectName = $_GET['SubjectName'];
                                            $query = "SELECT * FROM returnbooks where BookName ='$SubjectName'";
                                        }elseif(isset($_GET['FbDate'])){
                                            $date = $_GET['date'];
                                            $query = "SELECT * FROM returnbooks where IssuDate ='$date'";
                                        }else{
