            ...
            <div class="col-md-12">
                ...
                <?php
                    if(isset($_POST['Update'])){
                        ...
                        // select Student 
                        $query = "SELECT * FROM teacherdata WHERE ID='$StudentID'";
                        ...
                        ?>
                <!-- Update Teacher Login Details Form -->
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="LoginData.php" class=" row g-2 was-valideted updateForm" method="post">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="password" disabled  class="form-control is-valid"
                                    id="OldPassword" value="<?php echo $password ?>" name="OldPass" required />
                            </div>
                            <div class="col-md-6">
                                <label for="NewPassword" class="form-label"> New Password</label>
                                <input type="password" class="form-control is-valid" name="NewPass" id="password" required>
                                <span class="p-viewer2">
                                    <i class="bi bi-eye-slash" aria-hidden="true" id="togglePassword"> </i>
                                </span>
                            </div>
                            <div class="col-md-12">
                                <button type="submit" name="TechUpdate" class="btn btn-success">Update</button>
                            </div>
                        </form>
                    </div>
                </div>
